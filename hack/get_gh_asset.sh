...
# Adapted from: http://stackoverflow.com/a/35688093/55075    
# Usage: ./get_gh_asset.sh :owner :repo :tag :name
...
# Validate settings.
[ "$GH_TOKEN" ] || { echo "Error: Please define GH_TOKEN variable." >&2; exit 1; }
