...
import {toggleFavoriteUid} from '../../../shared/utils/favorites';
                                                ...
                                                <div className='columns small-4'>
                                                    <div className='row'>
                                                        <div className=' columns small-2'>
                                                            <div>
                                                                <Tooltip content={favList?.includes(app.metadata.uid) ? 'Remove Favorite' : 'Add Favorite'}>
                                                                    <button
                                                                        onClick={e => {
                                                                            e.stopPropagation();
                                                                            favList?.includes(app.metadata.uid)
                                                                                ? favList.splice(favList.indexOf(app.metadata.uid), 1)
                                                                                : favList.push(app.metadata.uid);
                                                                            const uid = app.metadata.uid;
                                                                            if (!uid) {
                                                                                return;
                                                                            }
                                                                            toggleFavoriteUid(uid, pref.appList);
                                                                        }}>
                                                                        <i
                                                                            className={favList?.includes(app.metadata.uid) ? 'fas fa-star' : 'far fa-star'}
                                                                            style={{
                                                                                cursor: 'pointer',
                                                                                marginRight: '7px',
                                                                                color: favList?.includes(app.metadata.uid) ? '#FFCE25' : '#8fa4b1'
                                                                            }}
                                                                        />
                                                                    </button>
                                                                </Tooltip>
