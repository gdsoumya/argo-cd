...
// GetDirectories provides a mock function with given fields: ctx, in, opts
func (_m *RepoServerServiceClient) GetDirectories(ctx context.Context, in *apiclient.GetDirectoriesRequest, opts ...grpc.CallOption) (*apiclient.GetDirectoriesResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *apiclient.GetDirectoriesResponse
	if rf, ok := ret.Get(0).(func(context.Context, *apiclient.GetDirectoriesRequest, ...grpc.CallOption) *apiclient.GetDirectoriesResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*apiclient.GetDirectoriesResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *apiclient.GetDirectoriesRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// GetFiles provides a mock function with given fields: ctx, in, opts
func (_m *RepoServerServiceClient) GetFiles(ctx context.Context, in *apiclient.GetFilesRequest, opts ...grpc.CallOption) (*apiclient.GetFilesResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *apiclient.GetFilesResponse
	if rf, ok := ret.Get(0).(func(context.Context, *apiclient.GetFilesRequest, ...grpc.CallOption) *apiclient.GetFilesResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*apiclient.GetFilesResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *apiclient.GetFilesRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
