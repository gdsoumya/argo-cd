...
func (in *ApplicationListStats) DeepCopyInto(out *ApplicationListStats) {
	*out = *in
	...
	if in.TotalByHydrationStatus != nil {
		in, out := &in.TotalByHydrationStatus, &out.TotalByHydrationStatus
		*out = make(map[HydrateOperationPhase]int64, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.TotalByOperationStatus != nil {
		in, out := &in.TotalByOperationStatus, &out.TotalByOperationStatus
